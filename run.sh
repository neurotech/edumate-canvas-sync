...
if [ -n "$DOCKER_NETWORK" ]; then
  ...
  docker run \
    ...
    -e CANVAS_API_DIFFING_DROP_STATUS=$CANVAS_API_DIFFING_DROP_STATUS \
    ...
    -e ROLLBAR_POST_SERVER_ITEM_ACCESS_TOKEN=$ROLLBAR_POST_SERVER_ITEM_ACCESS_TOKEN \
    -e EDUMATE_CANVAS_SYNC_SECRET=$EDUMATE_CANVAS_SYNC_SECRET \
    -e NODE_ENV=$NODE_ENV \
